...
const SHOWS = [
  ...
  { id: "tesla", name: "Тесла-шоу", price: 15000, emoji: "⚡", desc: "Научно-развлекательное представление, вдохновлённое изобретениями Николы Теслы. Оно превращает сложные физические явления в зрелищные эксперименты, создаёт атмосферу научно-фантастического праздника. В ходе шоу гостей ожидает: • демонстрация молний до 50 см на катушке Тесла • управление ручными молниями • зажигание люмиесцентных ламп • зажигание лампочки с помощью катушки Тесла", gradient: "from-[#a18cd1] to-[#fbc2eb]", image: "/shows/tesla.png" },
